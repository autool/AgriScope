...
6. 田间监测站、物联网设备、幂等遥测、设备故障闭环、AI 病虫害模型版本、人工复核与告警送达已实现；病虫害报告已支持真实识别结果组卷、专家会商实体答复、县市省三级审核和 XLSX 电子台账。外业核查移动端 GPS、现场属性、照片实体与弱网补传已实现。无人机任务及地图化规划已实现，无人机移动端采集、飞控实时接入与 10000 台设备规模验证仍待继续建设。
