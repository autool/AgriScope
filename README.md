...
- 五个真实 Landsat-5 时相均未因源级承认产生 `processed` 文件；几何校正、行政区裁剪、增强和波段产品仍保持独立实体门禁
